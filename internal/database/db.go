...
func MigrateDBSchema() {
	...
	err := db.AutoMigrate(&model.User{}, &model.Category{}, &model.Brand{}, &model.Product{}, &model.ProductVariant{}, &model.Inventory{}, &model.Address{}, &model.Cart{}, &model.Promotion{}, &model.Order{}, &model.Payment{})
